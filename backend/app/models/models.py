...
class TrackingResult(Base):
    ...
    organic_page: Mapped[int | None] = mapped_column(Integer, nullable=True)
    ...
    aio_citation_position: Mapped[int | None] = mapped_column(Integer, nullable=True)
    aio_content: Mapped[str | None] = mapped_column(Text, nullable=True)
    screenshot_page1_path: Mapped[str | None] = mapped_column(Text, nullable=True)
    screenshot_page2_path: Mapped[str | None] = mapped_column(Text, nullable=True)
    screenshot_aio_path: Mapped[str | None] = mapped_column(Text, nullable=True)
